...
from app.core.ui_indicator import Indicator
from app.shared.i18n import load_i18n
from app.shared.paths import APP_BASE_DIR, CONFIG_PATH
...
class MouseToVirtualGamepad:
    ...
    def run(self) -> None:
        indicator = Indicator(
            ...
            hud_fps_options_getter=current_hud_fps_options,
            window_clickthrough_setter=set_window_clickthrough,
        )
